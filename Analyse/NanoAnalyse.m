...
ListOfFunctions = {'Cantilever Stiffness','Mean Indents','Pentagonal Cantilever Stress-Strain','Exit'}; 
...
switch FunctionToUse
    case 'Cantilever Stiffness'
        NanoAnalyse_Cantilever_Stiffness(debugON,PlotAesthetics,DfltImgFmtType)
    case 'Mean Indents'
        NanoAnalyse_MeanIndents
    case 'Pentagonal Cantilever Stress-Strain'
