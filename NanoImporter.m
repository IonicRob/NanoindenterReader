...
function OutPut = NanoImporter(filename,IDName,bins,StdDevWeightingMode,LOC_load,debugON)
    %% Testing Section
    ...
    for currIndNum = 1:NumOfIndents
        ...
        indAvgTime = movmean(indProTime(1:currIndNum),[3 0],'omitnan');
            %indAvgTime = mean(indProTime(:),'omitnan');
        ...
        for BinNum=1:bins
            ...
            Bin_StdDev = std(DataInBin,1,'omitnan');
